...
const en: Dictionary = {
  ...
  header: {
    ...
    guides: 'Guides',
    salaryAndTaxes: 'Salary & IRPEF',
    contractsAndRegimes: 'Contracts & Regimes',
    ...
    salary: 'Salary',
    taxesAndRegimes: 'Taxes & Regimes',
    personalFinance: 'Personal Finance',
    salaryAnalysis: 'Salary Analysis',
    costAndSeverance: 'Cost & Severance',
    taxCalculation: 'Tax Calculation',
    taxRegimes: 'Tax Regimes',
    housingAndDebt: 'Housing & Debt',
    savingsAndFuture: 'Savings & Future',
    flagshipCta: 'Calculate now',
    flagshipDesc: 'Find out your net salary from your gross annual salary with IRPEF, INPS and regional surcharges.',
  },
  ...
  calcolatori: {
    ...
    ctaDescription: 'Read our tax guides to understand in detail how taxes and contributions work in Italy.',
    ctaButton: 'Explore Guides',
    netSalaryDesc: 'Calculate net salary from gross RAL with IRPEF, INPS, and surcharges.',
    grossSalaryDesc: 'Find out what gross salary (RAL) you need for your desired net pay.',
    irpefDesc: 'Calculate gross and net IRPEF with deductions, surcharges, and effective rate.',
    payslipDesc: 'Simulate a monthly payslip with all line items from gross to net.',
    regionComparisonDesc: 'Compare net salary across all Italian regions for the same gross pay.',
    thirteenthDesc: 'Calculate net 13th and 14th month bonus from your gross salary.',
    tfrDesc: 'Calculate gross and net TFR (severance) with separate taxation.',
    hourlyRateDesc: 'Convert your gross annual salary into hourly gross and net rates.',
    employerCostDesc: 'Calculate total employer cost including contributions and IRAP.',
    leaveDesc: 'Calculate vacation days, leave hours, and daily rate value.',
    severanceDesc: 'Calculate public sector severance pay (buonuscita).',
    familyDeductionsDesc: 'Calculate tax deductions for dependent spouse and children.',
    flatRateDesc: 'Simulate taxes and contributions for freelancers in the flat-rate regime.',
    impatriatiDesc: 'Calculate tax savings with the impatriati regime for returning workers.',
    employeeVsFreelancerDesc: 'Compare net income between employment and freelance flat-rate regime.',
    iseeDesc: 'Calculate ISEE value based on family income and assets.',
    mortgageDesc: 'Calculate monthly payment, total interest, and amortization schedule.',
    compoundInterestDesc: 'Simulate capital growth with compound interest over time.',
    pensionDesc: 'Estimate monthly pension based on age, contributions, and salary.',
    fireDesc: 'Calculate how much you need to achieve financial independence.',
    investmentTaxDesc: 'Calculate taxes on capital gains and investment returns.',
    rentVsBuyDesc: 'Compare total costs between renting and buying a property.',
    renovationBonusDesc: 'Calculate annual and total deductions for renovation work.',
    propertyGainsDesc: 'Calculate capital gains and substitute tax on property sales.',
    budgetDesc: 'Organize your finances with the 50/30/20 budget rule.',
    loanDesc: 'Calculate monthly payment, total interest, and APR for a loan.',
    savingsPlanDesc: 'Simulate the evolution of a savings plan (PAC) over time.',
    inflationDesc: 'Calculate the impact of inflation on purchasing power over time.',
  },
