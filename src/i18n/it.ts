...
const it = {
  ...
  header: {
    ...
    guides: 'Guide',
    salaryAndTaxes: 'Stipendio & IRPEF',
    contractsAndRegimes: 'Contratti & Regimi',
    ...
    salary: 'Stipendio',
    taxesAndRegimes: 'Tasse & Regimi',
    personalFinance: 'Finanza Personale',
    salaryAnalysis: 'Analisi Stipendio',
    costAndSeverance: 'Costo & Fine Rapporto',
    taxCalculation: 'Calcolo Tasse',
    taxRegimes: 'Regimi Fiscali',
    housingAndDebt: 'Casa & Debiti',
    savingsAndFuture: 'Risparmio & Futuro',
    flagshipCta: 'Calcola ora',
    flagshipDesc: 'Scopri il tuo stipendio netto partendo dalla RAL con IRPEF, INPS e addizionali regionali.',
  },
  ...
  calcolatori: {
    ...
    intro: 'Esplora tutti i nostri calcolatori gratuiti per gestire le tue finanze personali. Ogni strumento e\' aggiornato con le normative fiscali 2026 e include spiegazioni dettagliate.',
    workAndTaxes: 'Lavoro & Tasse',
    financeAndInvestments: 'Finanza & Investimenti',
    ctaTitle: 'Vuoi approfondire?',
    ctaDescription: 'Leggi le nostre guide fiscali per capire nel dettaglio come funzionano tasse e contributi in Italia.',
    ctaButton: 'Scopri le Guide',
    netSalaryDesc: 'Calcola lo stipendio netto partendo dalla RAL lorda con IRPEF, INPS e addizionali.',
    grossSalaryDesc: 'Scopri quale RAL ti serve per ottenere il netto mensile desiderato.',
    irpefDesc: 'Calcola IRPEF lorda e netta con detrazioni, addizionali e aliquota effettiva.',
    payslipDesc: 'Simula la busta paga mensile con tutte le voci dal lordo al netto.',
    regionComparisonDesc: 'Confronta lo stipendio netto tra tutte le regioni italiane a parita\' di RAL.',
    thirteenthDesc: 'Calcola tredicesima e quattordicesima nette partendo dalla RAL.',
    tfrDesc: 'Calcola il TFR lordo e netto con tassazione separata.',
    hourlyRateDesc: 'Converti la RAL in paga oraria lorda e netta.',
    employerCostDesc: 'Calcola il costo totale per il datore di lavoro inclusi contributi e IRAP.',
    leaveDesc: 'Calcola giorni di ferie, ore di permesso e valore giornaliero.',
    severanceDesc: 'Calcola la buonuscita per dipendenti del settore pubblico.',
    familyDeductionsDesc: 'Calcola le detrazioni per coniuge e figli a carico.',
    flatRateDesc: 'Simula tasse e contributi per Partita IVA in regime forfettario.',
    impatriatiDesc: 'Calcola il risparmio fiscale con il regime per lavoratori impatriati.',
    employeeVsFreelancerDesc: 'Confronta il netto tra lavoro dipendente e Partita IVA forfettaria.',
    iseeDesc: 'Calcola il valore ISEE in base a redditi e patrimonio familiare.',
    mortgageDesc: 'Calcola rata, interessi totali e piano di ammortamento del mutuo.',
    compoundInterestDesc: 'Simula la crescita del capitale con l\'interesse composto.',
    pensionDesc: 'Stima la pensione mensile in base a eta\', contributi e retribuzione.',
    fireDesc: 'Calcola quanto ti serve per raggiungere l\'indipendenza finanziaria.',
    investmentTaxDesc: 'Calcola le tasse su plusvalenze e rendimenti degli investimenti.',
    rentVsBuyDesc: 'Confronta i costi totali tra affitto e acquisto di un immobile.',
    renovationBonusDesc: 'Calcola la detrazione annua e totale per lavori di ristrutturazione.',
    propertyGainsDesc: 'Calcola la plusvalenza e l\'imposta sostitutiva sulla vendita immobiliare.',
    budgetDesc: 'Organizza le tue finanze con la regola del budget 50/30/20.',
    loanDesc: 'Calcola rata mensile, interessi totali e TAEG del prestito.',
    savingsPlanDesc: 'Simula l\'evoluzione di un Piano di Accumulo (PAC) nel tempo.',
    inflationDesc: 'Calcola l\'impatto dell\'inflazione sul potere d\'acquisto nel tempo.',
  },
};
